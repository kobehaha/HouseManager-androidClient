...
public class ImageLoadClientFactory {
	...
	public ImageLoadClientFactory(Activity activity, int n) {//传入activity和加载线程的数量,第二个参数为圆的参数
		...
		options = new DisplayImageOptions.Builder()
				...
				.showImageOnFail(R.drawable.display)
