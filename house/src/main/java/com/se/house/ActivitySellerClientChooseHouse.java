...
public class ActivitySellerClientChooseHouse extends BasicActivity {
	...
	private void init() {
		...
		new ImageLoadHouseFactory(ActivitySellerClientChooseHouse.this, 3);
		imageLoader = ImageLoadHouseFactory.getImageLoader();
		options = new ImageLoadHouseFactory(
				ActivitySellerClientChooseHouse.this, 3).getOptions();
	...
	public class Get_data extends AsyncTask<Integer, String, Integer> {
		ProgressDialog dialog = ProgressDialog.show(
				ActivitySellerClientChooseHouse.this, "提示", "加载数据中，请稍等", false,
				true);
		...
		protected void onPostExecute(Integer result) {
			...
			if (result == 1) {
				adapter = new AdapterSellerChooseHouse(
						// 绑定
						ActivitySellerClientChooseHouse.this, listHouse,
						imageLoader, options);
				...
				Toast.makeText(ActivitySellerClientChooseHouse.this,
